...
def get_user_def_tally_base(base_class=models.Model, return_all=False):
    """
    Creates a user def tally base class for a certain base class.

    @param base_class: Class
        The base class to base the returned class on. Defaults to
        django.db.models.Model.
    @param return_all: bool
        If true all three intermediate classes will be returned, otherwise just
        the final one. Defaults to false.
    @return: Class
        The generated base class.
    """

    class UserDefTallyBaseNonFiltered(Tally, base_class):
